function [Sum]=ComputeSize2(Input)
...
%Input=[1;522;65;211;137;156;400;195;451;249;398;613];
...
%return;
%%
tree_cell(1).left=build_btree_parent3(node_number,1,de(1),de(1),1); %节点是2(parent,p,eh,ev,np)
